...
export const LegalContact = () => {
  ...
  const [otpSentForPermanent, setOtpSentForPermanent] = useState(false);
  const [otpSentForSecondary, setOtpSentForSecondary] = useState(false);
  ...
  const handleSendOtp = (isPermanent) => {
    if (isPermanent) {
      if (permanentNumber.length !== 10 || isNaN(permanentNumber)) {
        Swal.fire({
          title: "Error",
