      ...
      <div className="dashboard container">
        ...
        <div className="content">
          ...
          <div className="slider" style={{gap:'50px',justifyContent:'center'}}>
              {platforms.map((item) => {
                return (
                  <div className="" style={{border:'2px solid var(--bg-highlight)', borderRadius:'10px',width:'300px',height:'300px',display:'flex',justifyContent:'center',alignItems:'center',boxShadow:'0px 4px 4px rgba(29, 140, 242, 0.08)',backgroundColor:'rgba(244, 248, 251, 0.342)'}}>
