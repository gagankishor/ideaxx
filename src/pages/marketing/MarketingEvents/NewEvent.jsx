...
export const NewEvent = () => {
  ...
  const EventSection = ({
    ...
    <div>
      <h3 style={commonStyles}>
        {title}
        <p style={{ textAlign: "left" }}>{description}</p>
      </h3>
      {type === "textarea" ? (
        <textarea
          style={{ width: commonStyles.width }}
          placeholder={placeholder}
          name={fildName}
          value={eventDetails[fildName]}
                ...
                <div>
                  <h3 style={{ textAlign: "left", maxWidth: "500px" }}>
                    ...
                    <p style={{ textAlign: "left" }}>
                      ...
                      Whether it's introducing a new product, service, or
              ...
              <>
                ...
                <div>
                  <h3 style={{ textAlign: "left", maxWidth: "500px" }}>
                    ...
                    <p style={{ textAlign: "left" }}>
                      Tailor the content to your target audience's needs,
              ...
              <>
                <div>
                  <h3 id="" style={{ textAlign: "left", maxWidth: "500px" }}>
                    ...
                    <p style={{ textAlign: "left" }}>
                      ...
                      Whether it's increasing brand visibility, generating
                ...
                <div>
                  <h3 style={{ textAlign: "left", maxWidth: "500px" }}>
                    ...
                    <p style={{ textAlign: "left" }}>
                      ...
                      client's industry and objectives.
                    </p>
                  </h3>
                  <textarea
                    name="researchEvents"
                ...
                <div>
                  <h3 style={{ textAlign: "left", maxWidth: "500px" }}>
                    Promote Attendance
                    <p style={{ textAlign: "left" }}>
                      Utilise channels to promote the client's participation.
                    </p>
                  </h3>
                  <textarea
                ...
                <div>
                  <h3 style={{ textAlign: "left", maxWidth: "500px" }}>
                    ...
                    <p style={{ textAlign: "left" }}>
                      ...
                      event. Whether it's to increase brand awareness, promote
                ...
                <div>
                  <h3 style={{ textAlign: "left", maxWidth: "500px" }}>
                    ...
                    <p style={{ textAlign: "left" }}>
                      ...
                      can contribute to the event's success. This could involve
                ...
                <div>
                  <h3 style={{ textAlign: "left", maxWidth: "500px" }}>
                    ...
                    <p style={{ textAlign: "left" }}>
                      ...
                      preferences of your audience. Whether it's seasonal
                ...
                <div>
                  <h3 style={{ textAlign: "left", maxWidth: "500px" }}>
                    ...
                    <p style={{ textAlign: "left" }}>
                      ...
                      Whether it's to increase brand awareness, gather feedback,
